              ...
              <CardContent className="flex flex-col gap-5 px-5 py-5 md:px-6 md:py-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-md border border-k0-border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                  />
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <input
                        ...
                        className="rounded-md border border-k0-border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
                      />
                    </PopoverTrigger>
                ...
                <div>
                  ...
                  <select className="w-full rounded-md border border-k0-border px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary">
                  ...
                  <>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <div>
                        ...
                        <select
                          className="w-full rounded-md border border-k0-border bg-k0-surface px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
