...
import { CollaborationWrapper } from './collaboration-wrapper';
...
export const DashboardContent = async () => {
  ...
  return (
    <div style={{ backgroundColor: '#FEF4DD' }}>
      <div className="flex flex-1 flex-col p-2 min-h-[100vh]" style={{ backgroundColor: '#FEF4DD' }}>
        ...
        <div className="">
          ...
          <div className="flex flex-1 bg-white rounded-lg flex-col gap-6 p-6 border-2 border-gray-100">
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-sm">
                  <TrendingUpIcon className="size-4" style={{ color: '#34A853' }} />
                  <span className="font-medium" style={{ color: '#34A853' }}>+$391.20</span>
                ...
                <Card className="border border-gray-200">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="size-3 rounded-sm" style={{ backgroundColor: '#FBC02D' }}></div>
                          <span className="text-sm font-medium">Clover</span>
                        </div>
                        <span className="text-sm font-mono">186</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="h-2 rounded-full" style={{ width: '25%', backgroundColor: '#FBC02D' }}></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <div className="size-3 rounded-sm" style={{ backgroundColor: '#34A853' }}></div>
                          <span className="text-sm font-medium">Shopify</span>
                        </div>
                        <span className="text-sm font-mono">305</span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="h-2 rounded-full" style={{ width: '42%', backgroundColor: '#34A853' }}></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div className="h-2 rounded-full" style={{ width: '32%', backgroundColor: '#EF4444' }}></div>
                      </div>
                    </div>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex items-center gap-2 text-sm">
                        <TrendingUpIcon className="size-4" style={{ color: '#34A853' }} />
                        <span className="font-medium" style={{ color: '#34A853' }}>Trending up by 5.2%</span>
