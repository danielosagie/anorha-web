...
import footerImage from '@/app/[locale]/assets/FooterImage.png';
import { env } from '@/env';
...
import { InteractiveAsciiFilter } from '@/components/interactive-ascii-filter';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { InteractiveExperience } from './interactive-experience/interactive-experience';
        ...
        <div className="container mx-auto">
          <div className="flex h-full flex-col items-center gap-8 lg:flex-row mt-12">
            <motion.div
              ...
              className="flex h-full w-full max-w-lg flex-col gap-6 p-4"
            >
              <motion.h1
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2, duration: 0.6 }}
                className="font-semibold text-center font-white text-3xl text-white leading-tight md:text-4xl"
              >
                A platform to help you sell anything, everywhere, fast.
              </motion.h1>
              <Waitlist />
              <InteractiveExperience
                imageSrc={footerImage.src}
                laneDragEnabled={true}
                className="lg:hidden"
              />
